...
#sprite_pablo = [
#    pygame.transform.scale(pygame.image.load(f"assets/devs/pablo/pablo_{i}.png"), (550, 550))  
#    for i in range(1, 7)
#]

#sprite_emiliano = [
#    pygame.transform.scale(pygame.image.load(f"assets/devs/emiliano/emiliano_{i}.png"), (550, 550))  
#    for i in range(1, 7)
#]
...
def play():
    while True:
        ...
        P1_VS_BOT_BUTTON = Button(image=None, pos=(640, 260), 
                                  text_input="P1 vs BOT", font=get_font(45), base_color="#d7fcd4", hovering_color="Green")
        BOT_VS_BOT_BUTTON = Button(image=None, pos=(640, 360), 
                                   text_input="BOT vs BOT", font=get_font(45), base_color="#d7fcd4", hovering_color="Green")
        P1_VS_P2_BUTTON = Button(image=None, pos=(640, 460), 
                                  text_input="P1 vs P2", font=get_font(45), base_color="#d7fcd4", hovering_color="Green")
        BACK_BUTTON = Button(image=None, pos=(640, 650), 
                              text_input="BACK", font=get_font(75), base_color="#FCA9A4", hovering_color="Red")

        for button in [P1_VS_BOT_BUTTON, BOT_VS_BOT_BUTTON, P1_VS_P2_BUTTON, BACK_BUTTON]:
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if P1_VS_P2_BUTTON.checkForInput(PLAY_MOUSE_POS):
                    play_mode_p1_vs_p2()
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and current_time - last_click_time > cooldown:
                ...
                if COOPERAR_BUTTON.checkForInput(pygame.mouse.get_pos()) or TRAICIONAR_BUTTON.checkForInput(pygame.mouse.get_pos()):
                    ...
                    if current_bot_strategy == 'aleatorio':
                        ...
                        bot_decision = 'defiende' if last_opponent_decision is None else last_opponent_decision
...
def play_mode_p1_vs_p2():
    vid = Video("videos/introduccion.mp4")
    vid.set_size((1280, 720))
    video_playing = True
    while True:
        for event in pygame.event.get():
        ...
        if video_playing:
            ...
            MODE_TEXT = get_font(45).render("Modo: P1 vs P2", True, "White")
            MODE_RECT = MODE_TEXT.get_rect(center=(640, 360))
